...
>>>>>>> 7eb4f20a87b4735b2ded1cda5255b6d743f79518
...
<<<<<<< HEAD
Как настроить системные часы в UTC или localtime и наоборот?
========================================================================
=======
...
Localtime -- текущее время с учётом часового пояса, его прямо сейчас можно увидеть на экране вашего телефона.

UTC -- единый стандарт времени, к которому прибавляется ваш часовой пояс, чтобы получить локальное время, например: UTC+4 -- Москва, UTC+7 -- Новосибирск.
...
<<<<<<< HEAD
Как временно изменить параметр ядра с помощью sysctl?
==========================================
=======
...
<<<<<<< HEAD
Как задать и сохранить параметр ядра через sysctl?
===========================================
=======
...
<<<<<<< HEAD
OpenSSH позволяет создавать неограниченное количество алиасов для быстрых подключений. Чтобы сделать это, откроем (создадим) файл ** ~/.ssh/config** в любом текстовом редакторе и допишем следующее: 
=======
...
Где **foo** и **bar** -- имена сокращений (алиасов), которые будут использоваться для подключения. Для каждого могут быть указаны индивидуальные настройки, включая :ref:`различные SSH ключи <ssh-keys>` с помощью директивы **IdentityFile**.
=======
